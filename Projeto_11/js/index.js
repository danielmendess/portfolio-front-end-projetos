...
function atualizarPlacar() {
    ...
    if (vez == 'o') {
        $('.placar img').attr('src', 'images/o.png');
    } else {
        $('.placar img').attr('src', 'images/x.png');
    }
...
$(function () {
    ...
    $('.area').on('click', function() {
        ...
        if( $(this).find('img').length == 0 ) {
            ...
            if(vez == 'o') {
                $(this).html('<img src="images/o.png" style="height: 50px">');
                $(this).attr('data-marcado', 'o');
                vez = 'x';
            } else {
                $(this).html('<img src="images/x.png" style="height: 50px">');
